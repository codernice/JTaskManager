...
namespace JTaskManager.Service.Implements
{
    public class BaseService<T> : DbContext, IBaseService<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        public async Task<ApiResult<string>> AddAsync(T parm, bool Async = false)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResult<string>> AddListAsync(List<T> parm, bool Async = false)
        {
            var res = new ApiResult<string>() { statusCode = (int)ApiEnum.Error };
            try
            {
        ...
        /// <returns></returns>
        public async Task<ApiResult<T>> GetModelAsync(Expression<Func<T, bool>> where, bool Async = false)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResult<T>> GetModelAsync(string parm, bool Async = false)
        {
            var res = new ApiResult<T>
            {
                statusCode = 200,
		...
		/// <returns></returns>
        public async Task<ApiResult<Page<T>>> GetPagesAsync(PageParm parm, bool Async = false)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ApiResult<List<T>>> GetListAsync(bool Async = false)
        {
            var res = new ApiResult<List<T>>();
            try
            {
        ...
        /// <param name="parm">T</param>
        /// <returns></returns>
        public async Task<ApiResult<string>> UpdateAsync(T parm, bool Async = false)
        {
            var res = new ApiResult<string>() { statusCode = (int)ApiEnum.Error };
            try
            {
        ...
        /// <param name="parm">T</param>
        /// <returns></returns>
        public async Task<ApiResult<string>> UpdateAsync(List<T> parm, bool Async = false)
        {
            var res = new ApiResult<string>() { statusCode = (int)ApiEnum.Error };
            try
            {
        ...
        /// <param name="parm">string</param>
        /// <returns></returns>
        public async Task<ApiResult<string>> DeleteAsync(string parm, bool Async = false)
        {
            var res = new ApiResult<string>() { statusCode = (int)ApiEnum.Error };
            try
            {
        ...
        /// <param name="where">Expression<Func<T, bool>></param>
        /// <returns></returns>
        public async Task<ApiResult<string>> DeleteAsync(Expression<Func<T, bool>> where, bool Async = false)
        {
            var res = new ApiResult<string>() { statusCode = (int)ApiEnum.Error };
            try
            {
        ...
        #region 查询Count
        public async Task<ApiResult<ResultCount>> CountAsync(Expression<Func<T, bool>> where, bool Async = false)
        {
        ...
        #region 是否存在
        public async Task<ApiResult<ResultAny>> IsExistAsync(Expression<Func<T, bool>> where, bool Async = false)
        {
